...
Label_2 = ' Low  ';
Label_3 = 'Precip';
Mo_1 = {'Jan','Feb','March','April','May','June'};  % cell array
Mo_2 = {'July','Aug','Sep','Oct','Nov','Dec'};      % cell array    
Data_1 = [
   46	28	3.98
   51	31	3.7
   61	39	4.88
...
Data_2 = [
   ...
   59	40	4.45
   49	31	4.53];
fid = fopen(filename,'w+t');    % opens and writes/over-writes
if fid < 0                      % a file-identifier in fid (a handle)
